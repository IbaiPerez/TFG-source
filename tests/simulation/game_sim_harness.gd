...
func _capture_heuristic(ai: AIController) -> Dictionary:
	...
	return {
		...
		"resource_surplus_factor": AILiveFacts._resource_surplus_factor(ctx, phase),
		"max_front_pressure": AIDecisionCache._max_front_pressure(ctx),
		"buildable_slots": AILiveFacts._buildable_slots(ctx),
		"upgradeable_buildings": AILiveFacts._upgradeable_buildings(ctx),
