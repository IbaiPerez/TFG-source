...
func _aggregate_metrics(snapshots: Array) -> Dictionary:
	var paths := [
		...
		"economy.production.gross_gold",
		"economy.production.gross_food",
		"economy.production.troop_gold",
		"economy.production.troop_food",
		"economy.production.front_gold",
		"economy.production.front_food",
		"economy.production.net_gold",
		"economy.production.net_food",
		"deck.draw_pile",
		"deck.discard_pile",
		"deck.played_pile",
		...
		"military.troops_garrisoned",
		"military.troops_total",
		"military.garrison_max",
